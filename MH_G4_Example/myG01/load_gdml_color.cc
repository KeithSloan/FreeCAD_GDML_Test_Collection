...
int main(int argc,char **argv)
{
   ...
   // If you want to test performance with only one thread/one core
   // to compare geometrical type efficiences, issue the following commands
   // UImanager->ApplyCommand("/run/numberOfThreads 1");
   // UImanager->ApplyCommand("/run/useMaximumLogicalCores 1");
   // Did not seem to work
   // You can set the exnvoronmantal variable
   // export G4FORCENUMBEROFTHREADS=n
   // or export G4FORCENUMBEROFTHREADS=max
