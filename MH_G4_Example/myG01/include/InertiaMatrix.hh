...
public:
  ...
  InertiaMatrix& operator=(const InertiaMatrix& other);
  ...
  // return a new matrix which is this one moved to the object's center of mass
  InertiaMatrix aboutCM(G4ThreeVector cm, double Volume);

  // return a new matrix which is this one (assumed about CM), about the origin
  InertiaMatrix aboutOrigin(G4ThreeVector cm, double Volume);
